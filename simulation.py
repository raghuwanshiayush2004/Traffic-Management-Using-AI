...
# Use CNN to detect vehicles instead of manual counting
noOfCars = 0
noOfBikes = 0
noOfBuses =0
noOfTrucks = 0
...
class Vehicle(pygame.sprite.Sprite):
    def __init__(self, lane, vehicleClass, direction_number, direction, will_turn):
        ...
        path = "images1/" + direction + "/" + vehicleClass + ".png"
                ...
                if(self.crossed==0 or self.x+self.currentImage.get_rect().width<mid[self.direction]['x']):
                    ...
                    if(self.turned==0):
                        ...
                        if(self.rotateAngle==90):
                            self.turned = 1
                            # path = "images1/" + directionNumbers[((self.direction_number+1)%noOfSignals)] + "/" + self.vehicleClass + ".png"
...
class Main:
    ...
    # Loading signal images1 and font
    redSignal = pygame.image.load('images1/signals/red.png')
    yellowSignal = pygame.image.load('images1/signals/yellow.png')
    greenSignal = pygame.image.load('images1/signals/green.png')
